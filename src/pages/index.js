  ...
  return (
    <>
      ...
      <div>
        ...
        <TableauEmbed sourceUrl='https://public.tableau.com/views/BigGameCensus2024/BigGameCensus?:language=en-US&:sid=&:display_count=n&:origin=viz_share_link' />
        <TableauEmbed sourceUrl='https://public.tableau.com/views/AnthonyBourdainTravels_17056586957790/viz?:language=en-US&:sid=&:display_count=n&:origin=viz_share_link' />
        <TableauEmbed sourceUrl='https://public.tableau.com/views/JustBeYourself-DataPlusMovies/ActionJustBeYourself?:language=en-US&:sid=&:display_count=n&:origin=viz_share_link' />
      </div>
    </>
  );
}
